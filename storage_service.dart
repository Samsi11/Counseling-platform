...
class StorageService {
  ...
  static Future<bool> updateBooking(Map<String, dynamic> updatedBooking) async {
    final bookings = getBookings();
    final bookingIndex = bookings.indexWhere((b) => b['id'] == updatedBooking['id']);
    if (bookingIndex != -1) {
  ...
  static Future<bool> updatePost(Map<String, dynamic> updatedPost) async {
    final posts = getPosts();
    final postIndex = posts.indexWhere((p) => p['id'] == updatedPost['id']);
    if (postIndex != -1) {
